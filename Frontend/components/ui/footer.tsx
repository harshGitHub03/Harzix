  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div
          className={`flex flex-col justify-between gap-8 py-8 md:flex-row md:items-center md:py-12 ${
            border
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-gray-600">
              &copy; {new Date().getFullYear()} Harzix — All rights reserved.
            </div>
          </div>
